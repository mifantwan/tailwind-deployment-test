...
/* harmony import */ var core_js_modules_es_object_values_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6034);
...
var customScrollBar = function customScrollBar() {
  ...
  var shouldShowScrollbar = function shouldShowScrollbar() {
    return window.innerWidth >= 768 && elements.list.scrollWidth > elements.list.clientWidth;
  };
  var updateScrollbar = function updateScrollbar() {
    ...
    var thumbPosition = maxScroll > 0 ? scrollLeft / maxScroll * (100 - thumbWidth) : 0;
    thumb.style.width = "".concat(thumbWidth, "%");
    thumb.style.left = "".concat(thumbPosition, "%");
  };
  ...
  var handleThumbDrag = function handleThumbDrag(e) {
    if (!isDragging) return;
    var track = elements.track,
      list = elements.list;
    var rect = track.getBoundingClientRect();
    var percentage = Math.max(0, Math.min(1, (e.clientX - rect.left) / rect.width));
    var maxScroll = list.scrollWidth - list.clientWidth;
    list.scrollLeft = percentage * maxScroll;
  };

  // Set default styles with transitions
  var setScrollbarStyles = function setScrollbarStyles() {
    var track = elements.track,
      thumb = elements.thumb;
    var styles = {
  ...
  var setHoverHeight = function setHoverHeight(height) {
    var track = elements.track,
      thumb = elements.thumb;
  ...
  elements.scrollbar.addEventListener('mouseenter', function () {
    setHoverHeight('6px');
  });
  elements.scrollbar.addEventListener('mouseleave', function () {
    setHoverHeight('2px');
  });
  ...
  elements.thumb.addEventListener('mousedown', function (e) {
    isDragging = true;
    e.preventDefault();
  });
